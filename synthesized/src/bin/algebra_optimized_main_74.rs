...
fn main() {
	...
	let val10 = 0 * &c3_0 * &c2 * &c1 * &c0 +
		...
		2 * &c4 * &c3 * &c2 * &c1_0 * &c0 +
		1 * &c5 * &c3 * &c2 * &c1_0 * &c0 +
		3 * &c4 * &c3 * &c2_0 * &c1_0 * &c0 +
		2 * &c5 * &c3 * &c2_0 * &c1_0 * &c0 +
		2 * &c4 * &c3 * &c2 * &c1 * &c0_0 +
		1 * &c5 * &c3 * &c2 * &c1 * &c0_0 +
		3 * &c4 * &c3 * &c2_0 * &c1 * &c0_0 +
		2 * &c5 * &c3 * &c2_0 * &c1 * &c0_0 +
		3 * &c4 * &c3 * &c2 * &c1_0 * &c0_0 +
		2 * &c5 * &c3 * &c2 * &c1_0 * &c0_0 +
		4 * &c4 * &c3 * &c2_0 * &c1_0 * &c0_0 +
		3 * &c5 * &c3 * &c2_0 * &c1_0 * &c0_0;
